...
> _Archival record of the one-time build+cutover that produced today's stack. There is no ongoing "V1/V2" split — the stack is simply **Ordo**. Here, "V1" = the previous stack and "V2" = the substrate that was, at the time, under `v2/` — later flattened into the repo root (2026-07-24, commit `2d4bd9c`)._
