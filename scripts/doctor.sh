...
echo "==> Probes (optional: Ollama/MCP on localhost only if you use expose overrides)"
probe_optional_backend_host "ollama /api/version" "${OLLAMA_URL:-http://localhost:11434}/api/version" "See overrides/ollama-expose.yml"
