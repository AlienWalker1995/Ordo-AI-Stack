"""Routes ported to ops-controller in slice 4.

`/comfyui/install-node-requirements` is a live verb; `/gpu/assign` and
`/registry/models/{id}/assign-gpu` are the two that ops-api answers 410 GONE, and the 410 has
