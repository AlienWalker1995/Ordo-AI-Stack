...
class SecretFile:
    """A file-form secret: the store key whose value is written to out/secrets/<file>."""
    key: str
    file: str
    service: str
...
def materialize(store: Store, needs: SecretNeeds, out_dir: Path, *, strict: bool = True,
    ...
    already is that file) and each file-form secret under out/secrets/.
    ...
    return Materialized(secrets_env, blank_required, blank_optional, files)
