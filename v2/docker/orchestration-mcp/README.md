...
`ordo/orchestration-mcp:latest`. V1 builds it locally
...
Backing verified in V2: the `ordo/dashboard-v1` image serves `/api/orchestration/*`
...
```
docker build -t ordo/orchestration-mcp:latest C:/dev/ordo-ai-stack/orchestration-mcp
```
