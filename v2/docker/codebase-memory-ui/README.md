...
`ordo/codebase-memory-ui:latest`. V1 builds it from `C:\dev\ordo-ai-stack\codebase-memory-ui`
...
## Build
```
docker build -t ordo/codebase-memory-ui:latest C:/dev/ordo-ai-stack/codebase-memory-ui
```
