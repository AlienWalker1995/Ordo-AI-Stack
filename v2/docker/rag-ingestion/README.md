...
V2's RAG ingester, referenced by the `rag` plugin as `ordo-v2/rag-ingestion:latest`. V1 builds it
...
## Build
```
docker build -t ordo-v2/rag-ingestion:latest C:/dev/ordo-ai-stack/rag-ingestion
```
